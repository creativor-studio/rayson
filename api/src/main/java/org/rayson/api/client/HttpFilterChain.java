...
/**
 * Filter chain on server side to do filter HTTP request and response.
 * 
 * @author Nick Zhang
 *
 */
public abstract interface HttpFilterChain extends FilterChain {
	 ...
	 */
	public abstract void doFilter(HttpClientRequest request, HttpClientResponse response) throws ClientFilterException;
}
